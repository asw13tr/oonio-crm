  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item"><a class="nav-link" aria-current="page" href="<?php url('customers'); ?>"><i class="fa fa-smile"></i> Müşteriler</a></li>
        ...
        <li class="nav-item"><a class="nav-link" aria-current="page" href="<?php url('home'); ?>"><i class="fa fa-check-double"></i> TO DO</a></li>
      </ul>
